...
export function PhoneFrame({ children, className }: FrameProps) {
  return (
    <div
      className={cn(
        "flex h-full w-full flex-col overflow-hidden rounded-[36px] border border-[color:var(--ink-line-strong)] bg-[color:var(--ink-bg-2)] p-2.5 shadow-[0_28px_70px_rgba(0,0,0,0.5)]",
        className,
      )}
    >
      <div className="relative flex min-h-0 flex-1 flex-col overflow-hidden rounded-[28px] border border-[color:var(--ink-line)] bg-[color:var(--ink-bg)]">
