...
export function Sidebar() {
  ...
  return (
    <aside className="flex flex-col h-screen sticky top-0 bg-[oklch(0.05_0.005_200)] border-r border-[color:var(--ink-line)] p-4">
      <div className="font-mono text-sm font-semibold tracking-tight pb-5 mb-3 border-b border-[color:var(--ink-line)]">
            ...
            <Link
              ...
              className={
                active
                  ...
                  : "flex items-center gap-2.5 px-3 py-2 rounded-lg text-sm text-[color:var(--ink-muted)] hover:bg-white/[0.04] hover:text-foreground transition"
              }
            >
      ...
      <div className="mt-4 pt-4 border-t border-[color:var(--ink-line)] flex items-center gap-2.5">
        ...
        {mounted && (
          <button onClick={() => setTheme(resolvedTheme === "dark" ? "light" : "dark")} aria-label="Toggle theme" className="size-7 inline-flex items-center justify-center rounded-md border border-[color:var(--ink-line)] hover:bg-white/[0.05] text-[color:var(--ink-muted)] hover:text-foreground transition">
            {resolvedTheme === "dark" ? <Sun className="w-3.5 h-3.5" /> : <Moon className="w-3.5 h-3.5" />}
          </button>
        )}
        <button onClick={signOut} aria-label="Sign out" className="size-7 inline-flex items-center justify-center rounded-md border border-[color:var(--ink-line)] hover:bg-white/[0.05] text-[color:var(--ink-muted)] hover:text-foreground transition">
